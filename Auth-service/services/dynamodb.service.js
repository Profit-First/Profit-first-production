...
class DynamoDBService {
    ...
    try {
      ...
      do {
        ...
        if (allUsers.length > 5000) {
          console.warn('getAllUsers: Reached 5000 user limit, stopping scan.');
          break;
        }
  ...
  async getUserById(userId) {
    try {
      // OPTIMIZATION: Use QueryCommand instead of ScanCommand.
      // Even if proper Key (PK+SK) is required for GetItem, Query on PK is efficient.
